...
'Sln1_[HK(H576)]_PT_Sln1_[RR(D1144)]': {
    'Rules':[
    'Sln1(RRD1144~P) + Sln1(RRD1144~U) <-> Sln1(RRD1144~U) + Sln1(RRD1144~P)'],
    'Tags': [
    1, 'Sln1', 'PT', 'no contingencies', 'ask MK']},

'Sln1_[RR(D1144)]_PT_Ypd1_[(H64)]': {
    'Rules':[
    'Sln1(H64~P) + Ypd1(H64~U) <-> Sln1(H64~U) + Ypd1(H64~P)'],
    'Tags': [
    1, 'Sln1', 'Ypd1', 'PT', 'no contingencies', 'ask MK']},

# PT contingencies
'Ypd1_[(H64)]_PT_Ssk1_[RR(D544)]; ! Ssk1_[RR]--Ypd1_[AssocSsk1]': {
    'Rules':[
    'Ssk1(RRD544~U,RR!1).Ypd1(RRD544~P,AssocSsk1!1) <-> Ssk1(RRD544~P,RR!1).Ypd1(RRD544~U,AssocSsk1!1)'],
    'Tags': [
